...
class WelcomeController extends Controller
{
    ...
    public function index(Struture $structure = null)
    {
        ...
        if ($structure) {
            $services = Service::all()->where('structure_id', $structure->id)->orderBy('position', 'asc');
    ...
    public function contact(Request $request)
    {
        ...
        Mail::to('gnoumbar7@icloud.com')->cc("mebodoaristide@gmail.com")->queue(new QueryMessage($request->all()));
